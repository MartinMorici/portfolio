            ...
            <section className=' flex justify-center flex-col font-roboto h-[1300px] sm:h-auto sm:py-[100px] '>
                ...
                <section className='p-4 flex flex-col sm:flex-row gap-12'>
                    <form ref={form} onSubmit={sendEmail} className='flex flex-col sm:max-w-[50%] w-full  text-white text-xl  '  >
                        <motion.input required className='bg-transparent border-b border-white outline-none mb-4 max-w-[450px] focus:border-amarillo placeholder-white  text py-2' type="text" name='asunto' placeholder='Asunto' {...reveal}  />
                        <motion.input required className='bg-transparent border-b border-white outline-none mb-4 max-w-[450px] focus:border-amarillo placeholder-white  text py-2' type="text" name='user_name' placeholder='Nombre' {...reveal}   />
