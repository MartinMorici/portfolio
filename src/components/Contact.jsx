...
const Contact = () => {
  ...
  return (
      <section className=' bg-gris-oscuro '>
          <Container>
            <section className=' flex justify-center flex-col font-roboto h-[1300px] sm:h-auto sm:py-[100px] '>
                <h2 className='w-fit leading-[0.95] text-white font-poppins font-semibold  text-[50px] sm:text-[75px] group transition-all' onMouseEnter={mouseEnterButton} onMouseLeave={mouseLeaveSectionss}>
                ...
                <section className='p-4 flex flex-col sm:flex-row gap-12'>
                    <form ref={form} onSubmit={sendEmail} className='flex flex-col sm:max-w-[50%] w-full  text-white text-xl  '>
                        <input required className='bg-transparent border-b border-white outline-none mb-4 max-w-[450px] focus:border-amarillo placeholder-white  text py-2' type="text" name='asunto' placeholder='Subject' />
                        <input required className='bg-transparent border-b border-white outline-none mb-4 max-w-[450px] focus:border-amarillo placeholder-white  text py-2' type="text" name='user_name' placeholder='Name' />
                        <input required className='bg-transparent border-b border-white outline-none max-w-[450px] focus:border-amarillo placeholder-white py-2' type="email" name="user_email" placeholder='Email' />
                        <label className='mt-8 mb-1' name="message" htmlFor="message">Message</label>
                        <textarea required className='bg-[#242329] outline-none p-4 border-b-2 text-lg focus:border-amarillo'  name="message" id="message" cols="30" rows="10"></textarea>
                    ...
                    <article>
                        <h3 className='text-white text-2xl font-roboto font-semibold'>Información de Contacto</h3>
                        <h3 className='mt-2 font-light text-white'>Si queres contactarte conmigo no dudes en hacerlo! Te dejo acá todos los links y redes disponibles.</h3>
                        <ul onMouseEnter={mouseEnterButton} onMouseLeave={mouseLeaveSectionss} className='flex flex-col w-fit gap-6 mt-4 text-white font-semibold'>
                            <li className=' text-white group flex w-fit'>
