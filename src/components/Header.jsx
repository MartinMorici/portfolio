    ...
    <header className='bg-hero-pattern svh text-white flex justify-center items-center' id='home'>
        ...
        <section className='flex flex-col svh justify-center items-center sm:block sm:h-auto'>
          <div className='font-poppins text-center'>
            ...
            <motion.h2 className='text-[19px] sm:text-[28px] sm:mt-[-20px] font-normal tracking-widest w-fit mx-auto font-roboto' viewport={{once:true}} initial={{opacity:0, y:40}} animate={{opacity:1,y:0}} transition={{type:'easeInOut', duration:.8}} onMouseEnter={mouseEnter} onMouseLeave={mouseLeave}>FRONT END DEVELOPER</motion.h2>
          </div>
